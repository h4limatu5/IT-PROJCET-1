...
<body>
    <nav class="sidebar">
        <h2>Dashboard</h2>
        <ul>
            <li class="active"><a href="{{ route('dashkaprodi') }}"><i class="fas fa-tachometer-alt"></i> Dashboard</a></li>
            ...
            <li><a href="{{ route('seminar.index', ['role' => 'kaprodi', 'user_id' => 1]) }}"><i class="fas fa-calendar-check"></i> Jadwal Seminar</a></li>
            <li><a href="{{ route('bimbingan.index', ['role' => 'kaprodi', 'user_id' => 1]) }}"><i class="fas fa-calendar-alt"></i> Jadwal Bimbingan</a></li>
            <li><a href="{{ route('nilai.index', ['role' => 'kaprodi', 'user_id' => 1]) }}"><i class="fas fa-calendar-alt"></i>Transkip Nilai</a></li>
            ...
            <div class="right-section">
                <div class="user-info">
                    ...
                    <div class="user-details">
                        <div class="user-name">Kaprodi</div>
                        <div class="user-role">Kepala Program Studi</div>
                    </div>
                </div>
            ...
            <div class="stats-cards">
                <div class="card blue">
                    ...
                    <div class="card-content">
                        <div class="card-title">Program Studi Saya</div>
                        <div class="card-value">{{ \App\Models\Prodi::count() }}</div>
                    </div>
                </div>
